...
export const ADDRESS_ENCRYPT_PRIVATEKEY = process.env.ADDRESS_ENCRYPT_PRIVATEKEY
...
export const ENCRYPTEDSEEDHEX = process.env.ENCRYPTEDSEEDHEX //escrow wallet encrypted seed hex
